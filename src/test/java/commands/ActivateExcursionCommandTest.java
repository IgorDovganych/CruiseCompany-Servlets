...
public class ActivateExcursionCommandTest {

    @InjectMocks
    ActivateExcursionCommand activateExcursionCommand;
    ...
    @Test
    public void execute() throws ServletException, DaoException, IOException {
        int id = 1;
        ...
        //act
        String result = activateExcursionCommand.execute(request,response);

        verify(excursionDao,times(1)).activateExcursion(id);
