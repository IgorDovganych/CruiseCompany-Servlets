...
public class ActivateCruiseCommandTest {

    @InjectMocks
    ActivateCruiseCommand activateCruiseCommand;
    ...
    public void executeTest() throws DaoException, ServletException, ParseException, IOException {
        ...
        //act
        String result = activateCruiseCommand.execute(request,response);

        verify(cruiseDao,times(1)).activateCruise(id);
