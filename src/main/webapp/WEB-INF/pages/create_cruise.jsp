...
<div style="background: aliceblue" class="center">
    <p class="center">
        <label for="start"><fmt:message key="startDate"/>:</label>
        ...
        <label for="end"><fmt:message key="endDate"/>:</label>
...
<div class="slidecontainer center" >
    ...
    <br>
    <button onclick="sendRequest('/FinalProjectJavaEE/admin/create_cruise', method='post')">
