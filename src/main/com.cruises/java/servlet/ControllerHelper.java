...
public class ControllerHelper {
    ...
    private ControllerHelper() {
        ...
        commands.put("/admin/activate_cruise", new ActivateCruiseCommand());
        commands.put("/admin/deactivate_cruise", new DeactivateCruiseCommand());
        commands.put("/admin/create_excursion", new CreateExcursion());
        commands.put("/admin/create_excursion_page", new CreateNewExcursionPageCommand());
    }
